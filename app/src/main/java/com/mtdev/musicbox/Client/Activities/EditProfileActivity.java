...
import com.mtdev.musicbox.Client.Utils.AppHelper;
import com.mtdev.musicbox.Client.VolleyMultipartRequest;
...
import static com.mtdev.musicbox.AppConfig.URL_UPDATEIMAGE;
...
public class EditProfileActivity extends AppCompatActivity {
        ...
        btnCapturePicture.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (image == null || image.trim().length() < 0) {
                    Toast.makeText(getApplicationContext(), "Pick an image", Toast.LENGTH_LONG).show();
                    return;
                }
    ...
    private void SendImage(final String image, final String pseudo, final String email, final String firstname, final String lastname) {
        ...
        Log.e("req to string", stringRequest.toString());
        try {
            Log.e("req body", stringRequest.getBody().toString());
