...
public class BulkDownloadService extends Service implements ArtworkManager.BulkLoadingProgressCallback {
    ...
    public static final String ACTION_CANCEL = "com.mtdev.musicbox.cancel_download";
    public static final String ACTION_START_BULKDOWNLOAD = "com.mtdev.musicbox.start_download";

    public static final String BUNDLE_KEY_ARTIST_PROVIDER = "com.mtdev.musicbox.artist_provider";
    public static final String BUNDLE_KEY_ALBUM_PROVIDER = "com.mtdev.musicbox.album_provider";
    public static final String BUNDLE_KEY_HTTP_COVER_REGEX = "com.mtdev.musicbox.http_cover_regex";
    public static final String BUNDLE_KEY_WIFI_ONLY = "com.mtdev.musicbox.wifi_only";
